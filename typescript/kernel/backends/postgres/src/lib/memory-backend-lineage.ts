...
// single ad hoc call sites in postgres-backend.ts that validate one write at
// a time and have no per-pass index to share.
 ...
 *   or `postgres_backend_cyclic_turn_node_lineage` on a lineage cycle.
 */

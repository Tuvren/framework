...
// are identical to the memory and SQLite backends' copies modulo the
// `postgres_backend_*` error-code prefix. See @tuvren/backend-shared for the
...
// below for postgres-specific lineage checks) and is injected into the shared
 ...
 *
 * @throws TuvrenPersistenceError
 *   `postgres_backend_invalid_consumed_staged_results_cbor` or

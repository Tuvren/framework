...
Tuvren WebSocket stream adapter leaf: carries the duplex session protocol (ADR-0060) and the event-stream resume cursor (ADR-0061) over a runtime-agnostic WebSocket transport, per ADR-0062.

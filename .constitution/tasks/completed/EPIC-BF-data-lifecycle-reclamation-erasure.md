...
- **Capability / Contract Mapping:** PRD `CAP-P0-067`; TechSpec ADR-0051
...
- **Capability / Contract Mapping:** PRD `CAP-P0-066`; TechSpec ADR-0051; `docs/KrakenKernelSpecification.md` §9.4
...
- **Capability / Contract Mapping:** PRD `CAP-P0-066`; TechSpec ADR-0051; `docs/KrakenKernelSpecification.md` §9.1, §9.4
...
- **Capability / Contract Mapping:** PRD `CAP-P0-067`; TechSpec ADR-0051; Architecture Secret Isolation / Data Lifecycle models
...
- **Capability / Contract Mapping:** PRD `CAP-P0-066`, `CAP-P0-067`; TechSpec ADR-0051

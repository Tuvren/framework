...
boundaries: [BND-03, BND-04, BND-16, BND-05, BND-17, BND-19]
view: sequence
certainty: assumed
...
Framework->>Runner: evaluate current iteration outcome
Runner-->>Framework: resolution = handoff or child delegation
...
Framework-->>Runner: continue with updated control ownership or child coordination primitives, preserving handoff and nested attribution semantics
```

...
- The normative docs claim inventory covers 253 matrix rows and 250 independent claims from `docs/KrakenFrameworkSpecification.md` and `docs/KrakenKernelSpecification.md`.

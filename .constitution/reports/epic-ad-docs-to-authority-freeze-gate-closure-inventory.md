...
- The normative docs claim inventory covers 264 matrix rows and 261 independent claims from `docs/KrakenFrameworkSpecification.md` and `docs/KrakenKernelSpecification.md`.
